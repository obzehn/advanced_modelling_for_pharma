...
The exact role of these molecules when targeting PKG is not strictly relevant for this tutorial. To fill the knowledge gap, you should read the corresponding publication [@el2019structures] from which the APO and HOLO + ANP structures were taken. Please notice however that the other two HOLO structures come from results that are deposited but unpublished. Thus, while they are enough for this tutorial, before using them for proper scientific work you should double check their validity and the status of the publication.
...
<div class="download-buttons">
  ...
  <a href="https://github.com/obzehn/advanced_modelling_for_pharma/raw/main/material/PKG_HOLO_1FB_exercise.tar.gz" class="btn">
    ...
    <span>Download PKG<br>HOLO - 1FB</span>
  </a>
  ...
  <a href="https://github.com/obzehn/advanced_modelling_for_pharma/raw/main/material/PKG_HOLO_1TR_exercise.tar.gz" class="btn">
    ...
    <span>Download PKG<br>HOLO - 1TR</span>
  </a>
  ...
  <a href="https://github.com/obzehn/advanced_modelling_for_pharma/raw/main/material/PKG_HOLO_ANP_exercise.tar.gz" class="btn">
    ...
    <span>Download PKG<br>HOLO - ANP</span>
  </a>
</div>
...
Try now to build the same system (but <u>do not use it</u>) by specifying a cubic (`-bt cubic`) box, you will end up with something like this
...
Final solvated dodecahedron box for the PKG+ANP HOLO system. ANP is represented as sticks. Ions are represented with their van der Waals radii and are in blue (sodium) and pink (magnesium). Water is reported as a transparent white surface.
