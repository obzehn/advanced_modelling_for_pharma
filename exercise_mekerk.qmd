...
The panels of @fig-mekerk-pbc shows a few ways in which the trajectory can be post-processed. Please consider also that the dodecahedron box is represented internally as a triclinic like box. The panels are
