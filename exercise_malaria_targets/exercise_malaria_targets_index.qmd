...
Several experimental structures have been deposited for PKG with UNIPROT [A5K0N4](https://www.uniprot.org/uniprotkb/A5K0N4/entry). The PDB IDs user in this tutorial are [5DYL](https://www.rcsb.org/structure/5DYL) for the APO form, [5DZC](https://www.rcsb.org/structure/5DZC) for the HOLO form bound to a non-hydrolyzable analog of adenosine triphosphate (here named ANP), [5F0A](https://www.rcsb.org/structure/5F0A) for the HOLO form bound to an inhibitor (here named 1FB), and [5FET](https://www.rcsb.org/structure/5FET) for the HOLO form bound to another inhibitor (here named 1TR). The structure of the ligand is shown in @fig-malaria-ligs.
